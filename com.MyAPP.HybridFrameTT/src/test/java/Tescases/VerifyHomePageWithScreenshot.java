...
public class VerifyHomePageWithScreenshot {
  ...
  Logger.log(LogStatus.INFO, "Started browser and nevigated to the URL,running app");
	...
	Logger.log(LogStatus.INFO, Logger.addScreenCapture(helper.captureScreenshot(driver, "LogInAttemptValidation1")));
	...
	public void tearDown(ITestResult result){
		...
		if(result.getStatus()==ITestResult.FAILURE){
			//2.THEN capture screenshot
			
		String imagePath=helper.captureScreenshot(driver, result.getName());
			//3.AND LOG it
